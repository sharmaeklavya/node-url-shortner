...
const emailer = async (email) => {
  try {
    ...
    await transporter.sendMail({
      ...
      html: `<div style="margin : 0 auto; width: 400px; padding:1rem; text-align:center;">
      <h1 style="font-size: 1.5rem; color: tomato;">Mini URLs</h1>
      <h2 style="font-size:1rem; color: rgba(31, 41, 55); text-align: left;"> <lead>Dear user,</lead> <br/> <br/>if you have requested for a new password. Please verify this email to reset the password or simply ignore this email.</h2>
      ...
      <a href="https://proj-url-shortner.netlify.app/update-password/${randomStr}" style="font-size: 1rem; padding:0.75rem; border:none; text-decoration:none; background-color: rgb(76, 175, 75); color: whitesmoke; cursor:pointer;">Reset Now</a>
      </div>`,
    });
  } catch (error) {
    console.error(error);
